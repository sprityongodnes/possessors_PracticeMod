...
- **💾 Savestates (5 Slots) :** Saves player position, rotation, health, ammo, and `SaveSlotSubsystem` game data. / _Sauvegarde la position, la rotation, la santé, les munitions et l'état du jeu._
